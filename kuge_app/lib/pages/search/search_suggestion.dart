...
class SuggestionSection extends StatelessWidget {
  const SuggestionSection({Key? key, required this.title, required this.content, required this.onDeleteClicked})
      : super(key: key);
...
class SuggestionOverflow extends StatefulWidget {
  const SuggestionOverflow({required this.query, required this.onSuggestionSelected});
